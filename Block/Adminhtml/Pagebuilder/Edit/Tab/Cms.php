    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
     ...
     * @return Page|null
     */
    private function findCurrentPage($pageId = 0): ?Page
    {
        if ($pageId) {
    ...
    protected function _prepareForm()
    {
        ...
        $cmsFieldset = $form->addFieldset(
            'cms_fieldset',
            ['legend' => __('CMS Content'), 'class' => 'fieldset-wide', 'disabled' => $isElementDisabled]
        );

        $cmsFieldset->addField(
            'content_heading',
            'text',
            [
        ...
        $layoutFieldset->addField(
            ...
            [
                ...
                'label' => __('Custom Layout Update'),
                'tooltip' => __('List of layout files with an update handle "selectable"
                matching *PageIdentifier*_*UpdateID*.
                &lt;br/&gt;
                See Magento documentation for more information'),
                'note' => __('List of layout files with an update handle "selectable"
                matching *PageIdentifier*_*UpdateID*.
                &lt;br/&gt;
                See Magento documentation for more information'),
                'values' => $options,
